...
func _ready():
	...
	if (SaveManager.load_on_start):
		...
		SaveManager.fluffy_list[0] = SaveManager.preloaded_fluffy.instantiate()
		SaveManager.fluffy_list[0].add_to_group("Persist")
		SaveManager.fluffy_list[0].scale = Vector2(0.6, 0.6)
		SaveManager.fluffy_list[0].position = Vector2(661, 233)
		SaveManager.fluffy_list[0].name = "Child"
		SaveManager.fluffy_list[1] = SaveManager.preloaded_fluffy.instantiate()
		SaveManager.fluffy_list[1].add_to_group("Persist")
		SaveManager.fluffy_list[1].scale = Vector2(0.3, 0.3)
		SaveManager.fluffy_list[1].position = Vector2(162, 101)
		SaveManager.fluffy_list[1].name = "Mom"
		SaveManager.fluffy_list[2] = SaveManager.preloaded_fluffy.instantiate()
		SaveManager.fluffy_list[2].add_to_group("Persist")
		SaveManager.fluffy_list[2].scale = Vector2(0.3, 0.3)
		SaveManager.fluffy_list[2].position = Vector2(173, 355)
		SaveManager.fluffy_list[2].name = "Dad"
		
		_on_random_parents_pressed()
			
		$MarginContainer/VBoxContainer/PanelContainer.add_child(SaveManager.fluffy_list[0])
		$MarginContainer/VBoxContainer/PanelContainer/SplitBox/PanelContainer3/GridContainer.add_child(SaveManager.fluffy_list[1])
		$MarginContainer/VBoxContainer/PanelContainer/SplitBox/PanelContainer3/GridContainer.add_child(SaveManager.fluffy_list[2])
		#target_fluffy.color_coat = $MarginContainer/VBoxContainer/PanelContainer2/ColorPickerButton.color
		#$MarginContainer/VBoxContainer/PanelContainer2/ColorPickerButton2.color = target_fluffy.color_eye
		#$MarginContainer/VBoxContainer/PanelContainer2/ColorPickerButton3.color = target_fluffy.color_eye
		
		#$MarginContainer/VBoxContainer/PanelContainer/Fluffy.color_coat = $MarginContainer/VBoxContainer/PanelContainer2/ColorPickerButton.color
		#$MarginContainer/VBoxContainer/PanelContainer/Fluffy.color_eye = $MarginContainer/VBoxContainer/PanelContainer2/ColorPickerButton2.color
		#$MarginContainer/VBoxContainer/PanelContainer/Fluffy.color_mane = $MarginContainer/VBoxContainer/PanelContainer2/ColorPickerButton3.color
...
func update_fluffy_one():
	var my_genome = SaveManager.fluffy_list[0].my_genome
...
func _on_color_picker_button_color_changed(color):
	SaveManager.fluffy_list[0].color_coat = color
...
func _on_color_picker_button_2_color_changed(color):
	SaveManager.fluffy_list[0].color_eye = color
...
func _on_option_button_3_toggled(button_pressed):
	SaveManager.fluffy_list[0].has_wings = button_pressed
...
func _on_check_button_2_toggled(button_pressed):
	SaveManager.fluffy_list[0].crazy = button_pressed
...
func _on_check_button_3_toggled(button_pressed):
	SaveManager.fluffy_list[0].shaved = button_pressed
...
func _on_genetic_generator_pressed():
	SaveManager.fluffy_list[0].randomize_genome()
	update_fluffy_one()



func _on_random_parents_pressed():
	SaveManager.fluffy_list[1].randomize_genome(1)
	SaveManager.fluffy_list[2].randomize_genome(0)
...
func _on_genetic_generator_2_pressed():
	...
	var my_father_genome = SaveManager.fluffy_list[2].my_genome
	var my_mother_genome = SaveManager.fluffy_list[1].my_genome
	SaveManager.fluffy_list[0].my_genome._cross_breed_genes(my_father_genome.genes, my_mother_genome.genes)
	update_fluffy_one()
